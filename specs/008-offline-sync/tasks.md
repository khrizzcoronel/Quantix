...
- [ ] **TASK-008-01:** Implementar endpoint `GET /api/v1/health` (heartbeat ultra-ligero < 20 ms).
...
- [ ] **TASK-008-05:** Configurar base de datos SQLite local en la terminal (o motor IndexedDB en frontend).
